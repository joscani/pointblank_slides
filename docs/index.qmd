...
```{r agente_save_disk, echo = TRUE, results='hide', `code-line-numbers`="2"}
...
```{r agente_read_from_disk, echo = TRUE, results='hide', `code-line-numbers`="2"}
...
```{r agente_from_disk_interrogate, echo = TRUE, results='hide', `code-line-numbers`="2-3"}
agente_from_disk  |> 
