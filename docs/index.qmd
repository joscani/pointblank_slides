---
title: "Validación de datos con pointblank (en spark)"
subtitle: "\"Usando el paquete `pointblank`\""
...
::: {.column width="45%"}
::: fragment
![](images/edades_negativas.jpg){.memes width="230px" height="500px"}
:::
:::
:::
...
```{r action_levels, echo = TRUE, results='hide', `code-line-numbers`="2-5"}
